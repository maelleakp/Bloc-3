...
function checkPassGardien() {
    if (document.getElementById("form1").gardien.value == "") {
        alert("Veuillez sélectionner un gardien");
    }
...
function checkPassJoueur() {
    if (document.getElementById("form").joueur.value == ""){
